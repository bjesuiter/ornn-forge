/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8a4935728738b2047ffc9be0def0e269)
// Runtime types generated with workerd@1.20260708.1 2026-07-10 nodejs_compat
interface __BaseEnv_Env {
	ORNN_D1: D1Database;
	BETTER_AUTH_URL: "https://ornn-forge.bjesuiter.workers.dev";
	DASHBOARD_OPERATOR_GITHUB_IDS: "2365676";
	GITHUB_APP_INSTALLATION_ID: "159365588";
	GITHUB_CLIENT_ID: "Iv23livaCskLFocJZnOQ";
	GITHUB_REPOSITORY_ID: "1296836371";
	GITHUB_REPOSITORY_FULL_NAME: "bjesuiter/ornn-forge";
	RUNNER_CONNECTION: DurableObjectNamespace<import("./src/server").RunnerConnection>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "RunnerConnection";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "DASHBOARD_OPERATOR_GITHUB_IDS" | "GITHUB_APP_INSTALLATION_ID" | "GITHUB_CLIENT_ID" | "GITHUB_REPOSITORY_ID" | "GITHUB_REPOSITORY_FULL_NAME">> {}
}
