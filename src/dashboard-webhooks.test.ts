  ...
  const webhooks = dashboardWebhooksFromRows([
    {
      ...
      accepted_at: '2026-09-06T12:00:00.000Z', state: 'succeeded', latest_attempt: 'succeeded',
    },
    {
      ...
      accepted_at: '2026-09-06T11:59:00.000Z', state: 'leased', latest_attempt: 'pending',
    },
    {
      ...
      accepted_at: '2026-09-06T11:58:00.000Z', state: 'succeeded', latest_attempt: 'uncertain',
    },
  ])
  ...
  expect(webhooks).toEqual([
    {
      ...
      source: 'comment', status: 'completed',
    },
    {
